...
const Title = ({ children, className, asChild, ...props }: React.ComponentProps<"h4"> & { asChild?: boolean }) => {
	...
	return (
		<Comp date-component="stepper-step-title" className={cn("font-medium text-base", className)} {...props}>
			{children}
		</Comp>
	);
};
...
// biome-ignore lint/style/noNamespace: "Third party implementation"
namespace Stepper {
